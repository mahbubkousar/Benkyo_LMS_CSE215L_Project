...
public class LoginController implements Initializable {
    ...
    private void handel_login(ActionEvent event) throws IOException {
        if(loginID.getText().equals("mahbub") && loginPassword.getText().equals("1234") ){
            wrongpass.setText(" ");
            Parent main = FXMLLoader.load(getClass().getResource("/loginapplication/afterlogin/Main.fxml"));
